...
\begin{abstract}
Este é o texto escrito durante a iniciação científica do aluno de graduação João Guilherme Alves Santos sob supervisão da Profa.\ Dra.\ Cristina Gomes Fernandes.
\end{abstract}
...
\tableofcontents
\addtocontents{toc}{\label{revisao} \protect\footnotetext[1]{ Essas seções ainda serão revisadas e, possivelmente, passarão por alterações}}
\newpage
...
\subsection{Busca local\ref{revisao}}
    \input{facility/buscalocal.tex}
\newpage

\subsection{Algoritmo guloso\ref{revisao}}
